...
const AboutPage = () => {
  return (
    <div className='relative overflow-hidden pt-[240px] pb-[162px] flex flex-col items-center justify-center gap-[114px] bg-[#F7F7FB]'>
      <div className='pointer-events-none absolute inset-0 overflow-hidden'>
        <div
          className='absolute -top-[180px] -left-[160px] w-[560px] h-[560px] rounded-full bg-[#F7F869]'
          style={{ filter: 'blur(110px)', opacity: 0.45 }}
        />
        <div
          className='absolute -top-[220px] -right-[200px] w-[640px] h-[640px] rounded-full bg-[#8CBE2C]'
          style={{ filter: 'blur(120px)', opacity: 0.3 }}
        />
        <div
          className='absolute top-[420px] left-1/2 -translate-x-1/2 w-[900px] h-[500px] rounded-full bg-[#B7D98C]'
          style={{ filter: 'blur(130px)', opacity: 0.35 }}
        />
        <svg className='absolute top-[110px] left-[120px]' width="18" height="18" viewBox="0 0 18 18" fill="none">
          <circle cx="9" cy="9" r="7" stroke="#8CBE2C" strokeWidth="2" opacity="0.4" />
        </svg>
        <svg className='absolute top-[260px] right-[160px]' width="14" height="14" viewBox="0 0 14 14" fill="none">
          <circle cx="7" cy="7" r="7" fill="#F7F869" opacity="0.6" />
        </svg>
        <svg className='absolute bottom-[120px] right-[280px]' width="22" height="22" viewBox="0 0 22 22" fill="none">
      ...
      <div className='relative z-10 flex flex-col items-center justify-center gap-6'>
        <div className='flex flex-col items-center justify-center'>
          ...
          <span className='font-extrabold text-[88px]'>
            모은심리상담센터
          </span>
        </div>
        <span className='text-[20px] text-[#767676] text-center'>
          아동청소년부터 성인까지, 개인상담·심리검사·집단상담을 통해
          더 성숙하고 건강한 나를 만들어가는 과정을 함께합니다.
        </span>
      </div>
      <div className='relative z-10 flex gap-[120px]'>
