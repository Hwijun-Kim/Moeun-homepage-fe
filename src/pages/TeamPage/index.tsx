...
const TeamPage = () => {
  return (
    <div className='bg-white w-full pt-16 sm:pt-20 lg:pt-[98px] pb-16 sm:pb-20 lg:pb-[122px] flex flex-col gap-8 items-center px-4' style={{ boxShadow: '0px 4px 30px 12px #00000014' }}>
      <div className='flex flex-col items-center w-full gap-10 sm:gap-16'>
        <div className='flex flex-col items-center w-full gap-1'>
          <span className='font-semibold text-[18px] sm:text-[22px] lg:text-[28px] text-center'>풍부한 경험과 전문성을 갖춘</span>
          <span className='font-semibold text-[28px] sm:text-[36px] lg:text-[44px] text-center'><span className='text-[#8CBE2C]'>상담진</span>을 소개합니다</span>
        </div>
        ...
        <div className='flex flex-wrap gap-4 sm:gap-6 w-full justify-center max-w-[1200px]'>
          {counselors.map((counselor, index) => (
            <Tooltip key={index}>
              ...
              <TooltipContent side='bottom' className='w-[90vw] max-w-[380px] py-4 flex justify-center items-center border-0 bg-[#FFFFFF]/90' style={{ boxShadow: '10px 10px 30px 0px #2F4B2214' }}>
